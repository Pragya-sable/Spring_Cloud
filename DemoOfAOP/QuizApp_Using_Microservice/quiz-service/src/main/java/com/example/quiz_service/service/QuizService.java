...
import com.example.quiz_service.finge.QuizInterface;
...
public class QuizService {
    ...
    public ResponseEntity<String> createQuiz(String category, Integer Que, String title) {
      List<Integer> questions = quizInterface.getQuestionForQuiz(category,Que).getBody();
      Quiz quiz = new Quiz();
      quiz.setTitle(title);
      quiz.setQuestion_id(questions);
      quizDao.save(quiz);
